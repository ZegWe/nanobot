...
# Ensure installed loose plugins are importable
from pathlib import Path as _Path
_plugins_path = str(_Path.home() / ".nanobot" / "plugins")
...
def plugins_install(
    path: str = typer.Argument(..., help="Path to the plugin package directory"),
